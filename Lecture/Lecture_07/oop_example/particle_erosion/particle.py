...
class Particle:
    ...
    def glide_on_mesh(self, mesh, mesh_vertex_coordinates, mesh_vertex_keys):
        ...
        if distance < self.min_distance:
            ...
            erosion_force = Vector(*(self.position - mesh_vertex_coordinates[index]))
            erosion_force.scale(0.2)
            new_pt = Point(*mesh_vertex_coordinates[index]) - erosion_force
            mesh_vertex_coordinates[index] = (new_pt.x, new_pt.y, new_pt.z)
