...
# ['bigx', 'grid', 'star', 'cross', 'octagon', 'octet', 'vintile', 'dual', 'interlock', 'isotrop', 'hexgrid']
lat = cvol_ms.Lattice(10, 15.0, 3, frame=cg.Frame(
    (1, 0, 0), (1, 0.2, 0.1), (-0.3, 1, 0.2)))
vm = cvol_c.Intersection(vb, lat)
