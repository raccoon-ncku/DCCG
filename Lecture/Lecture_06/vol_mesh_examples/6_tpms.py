...
# CSG tree
# VM object
b = cg.Box(cg.Frame.worldXY(), 30, 30, 30)
vb = cvol_p.VolBox(b, 0)

# ['Gyroid', 'SchwartzP', 'Diamond', 'Neovius', 'Lidinoid', 'FischerKoch']
shell = cvol_m.Shell(cvol_ms.TPMS(tpmstype='FischerKoch', wavelength=18), 0.33)
ol_plane = cvol_p.VolPlane(cg.Plane((-15, -15, -15), (-1, -1, -1)))
thicken_tpms = cvol_m.Overlay(shell, ol_plane, 0.005)
vm = cvol_c.Intersection(vb, thicken_tpms)
