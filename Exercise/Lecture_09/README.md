...
> Open-ended mesh practice. The [Week 09 checkpoints](/Lecture/Lecture_09/README.md#checkpoints)
...
> [`Lecture_09/mesh_examples/`](/Lecture/Lecture_09/README.md).

## 1. Colour a mesh by normal direction

Load a mesh (the Stanford bunny in `Lecture_09/mesh_examples/data/` is a good
...
and to `Lecture_09/mesh_applications/` — a good place to find a final-project
direction.
